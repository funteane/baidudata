...
public class DownloadScheduleJob extends AbstractJob{
	...
	private final static String token = "14085b1c9d84bb1b52b9b64cd6a71c08";
...
//		calendar.add(Calendar.DATE, -1);
		...
		for (BaiduAccount baiduAccount : accounts) {
			ApiContext apiContext = new ApiContext(baiduAccount.getUserName(), baiduAccount.getPassword(), Network.BAIDU ,Method.POST, token);
			//处理ROI
